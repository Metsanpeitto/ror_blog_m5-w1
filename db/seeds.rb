...
#   Character.create(name: 'Luke', movie: movies.first)
   User.create([{name: 'Juan',email:'asd@asd.com', photo: 'https://imgur.9823432/', bio: 'Lots of things to say in here'},
                        {name: 'Pako',email:'gfd@asd.com', photo: 'https://imgur.98234a4532/', bio: 'Lots of things to say in here'},
                        {name: 'Resta',email:'hgjg@asd.com', photo: 'https://imgur.sdasasd/', bio: 'Lots of things to say in here'}])
